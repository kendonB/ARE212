...
\begin{document}
	...
	Before we get into any of the details, I (and you) owe a great deal of thanks to \textbf{Dan Hammer}, a third-year colleague of ours in ARE who originally wrote many of these notes for the 2012 class. \textbf{Patrick Baylis} also made many excellent extensions and additions in 2013.\footnote{Dan's original notes are available at \href{https://github.com/danhammer/ARE212}{\texttt{https://github.com/danhammer/ARE212}} with Patrick Baylis's 2013 iteration at \href{https://github.com/pbaylis/ARE212}{\texttt{https://github.com/pbaylis/ARE212}}. Patrick's notes contain far more than I am able to comfortably get through in an hour, so check those out if you're interested in a bit more detail. Dan's, for the most part, are a subset of Patrick's.} My notes are likely to contribute to an ongoing 212-213 section notes project, so please point out errors and make suggestions.
	...
	%
	\subsection*{Homework}
	See Max's syllabus for details on problem sets and their grading. I will only add a gentle plea for you to carefully comment your code. In the short term, commenting is a useful way to force you to think about what your code is doing as you write it. In the medium term, it will allow you to look over your code one or two months later (e.g. when you are working on your midterm) and understand what you did quickly. In the long term, clear and well-commented code is a valuable habit that will serve you throughout your career. And finally, though it hardly bears mentioning, it will make my grading life easier and improve my general disposition towards your problem sets. Precise code style will also help a lot now and in your collaborating future. I recommend \href{https://google-styleguide.googlecode.com/svn/trunk/Rguide.xml}{Google's R code style guide.}
	%
