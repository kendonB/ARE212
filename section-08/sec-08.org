...
** Standard errors!
This is going to sound peevish, but many problem sets contained estimates without standard errors! Some of them weren't computable without using the delta method (which was not the focus of the problem set), but many of the neglected estimates were run-of-the-mill OLS coefficients, for which you probably know the standard error formula cold by now. Remember, coefficients without standard errors are very nearly meaningless.
...
:      0.00      0.67      2.01     21.33      5.96 145700.00
...
I could run this more, but I don't think it's going to become normal.
